...
# Blondie Social Media Agent - Caption Generator with Streamlit UI and Thumbnails
...
# --- CONFIG ---
COMIC_FOLDER = "./comics"  # Folder where .tif comics are stored
...
- Comic: Dagwood’s day was ‘blah’
    - IG: "Some days just scream BLAH. And so do we. 😐 #BlondieComic #BlahEnergy"
    - FB: "Dagwood said it best: ‘Blah, blah, blah!’ Ever had one of *those* days?"
- Comic: Dagwood tracked via GPS from snack stops
    - IG: "No need to call. Just open Find My Dagwood and follow the snack trail. 🍩➡️🍧"
    - FB: "Blondie’s tracking Dagwood through his snack run. Modern love!"
"""
    return f"""
{style_guide}
